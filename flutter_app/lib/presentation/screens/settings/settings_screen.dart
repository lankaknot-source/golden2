      ...
      body: ListView(
        children: [
          ...
          _SettingsTile(
            ...
            onTap: () => _launchUrl('https://goldenhandcaregivers.com'),
          ),
          _SettingsTile(
            icon: Icons.chat_outlined,
            iconColor: AppColors.info,
            title: 'Contact Us',
            subtitle: 'it@goldenhandcaregivers.com',
        ...
        child: Column(
          ...
          children: [
            ...
            _ContactOptionTile(
              ...
              title: 'Email Support',
              subtitle: 'it@goldenhandcaregivers.com',
              onTap: () => _launchUrl('mailto:it@goldenhandcaregivers.com'),
            ),
            const SizedBox(height: 12),
            _ContactOptionTile(
              ...
              subtitle: '0787004239',
              onTap: () => _launchUrl('tel:+94787004239'),
            ),
            const SizedBox(height: 12),
            _ContactOptionTile(
              ...
              title: 'Website',
              subtitle: 'goldenhandcaregivers.com',
              onTap: () => _launchUrl('https://goldenhandcaregivers.com'),
            ),
